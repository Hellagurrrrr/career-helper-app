...
| AI 对话采集   | OB-10 | 完成多轮问答        | 处于对话步骤            | 回答 AI 提出的问题，直到 AI 判断已收集到足够的信息从而停止询问                                                                                                                       | 最后一题回答后自动进入 Review 步骤                                                                              |
| AI 对话采集   | OB-11 | 空消息不可发送       | 处于对话步骤            | 输入框为空时尝试发送                                                                                                                                                | 无法发送                                                                                               |
| AI 对话采集   | OB-12 | 对话中断后再次选择对话采集 | 在进行OB-10时退出对话     | 再次选择对话采集                                                                                                                                                  | 从中断的对话节点开始继续对话                                                                                     |
