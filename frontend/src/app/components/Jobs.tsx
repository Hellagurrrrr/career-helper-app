...
export function Jobs() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <p className="mb-2 text-sm font-medium text-blue-700">Job search</p>
        <h1 className="text-3xl font-bold tracking-tight text-slate-950">
          Find your next role
        </h1>
        <p className="mt-2 text-slate-600">
          Curated openings and partner referrals tailored to your career goals.
        </p>
      </div>
      ...
      {goals.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-slate-300 bg-white p-10 text-center">
          ...
          <h3 className="text-base font-semibold text-slate-950">No career goals yet</h3>
          <p className="max-w-sm text-sm text-slate-600">
            Add a career goal to unlock tailored job recommendations and partner
            referral roles.
          </p>
          <Link
            to="/new-goal"
